export const getOverrides = (theme) => {
  ...
  return {
    ...
    'paneProperties.legendProperties.showSeriesTitle': false, // 是否显示币种标题

    // 标题旁详情
    'paneProperties.legendProperties.showSeriesOHLC': false,
    // 展开按钮
    'paneProperties.legendProperties.showLegend': false, // 是否显示展开按钮
    // 标题旁百分比
    ...
    'scalesProperties.fontSize': 14, // 设置刻度线和文本的颜色和大小
